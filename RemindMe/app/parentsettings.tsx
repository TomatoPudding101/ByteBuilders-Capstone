        ...
        {activeTab === 'goals' && (
          <>
            ...
            <View style={styles.card}>
              ...
              {goals.filter(g => g.type === 'chore').length === 0 && <Text style={styles.emptyMsg}>No chores added yet.</Text>}
            ...
            <View style={styles.card}>
              ...
              {goals.filter(g => g.type === 'goal').length === 0 && <Text style={styles.emptyMsg}>No weekly goals added yet.</Text>}
        ...
        {activeTab === 'parental' && (
          <>
            <View style={styles.card}>
              ...
              <Text style={styles.cardSub}>Current total synced from progress page</Text>
            ...
            <View style={styles.card}>
              <Text style={styles.cardTitle}>Deduct Points for Redeemed Rewards</Text>
              <Text style={styles.cardSub}>Tap "Deduct" when your child redeems a reward</Text>
              {deductMsg ? (
          ...
          <View style={styles.card}>
            ...
            <View style={styles.settingRow}>
              <View style={styles.settingInfo}>
                ...
                <Text style={styles.settingDesc}>Coming soon!</Text>              </View>
              <Switch value={darkMode} onValueChange={setDarkMode} trackColor={{ true: '#8b6fd4', false: '#ddd' }} />
            </View>
          </View>
        )}
          ...
          <View style={styles.card}>
            ...
            {notificationSettings.map((item) => (
              <View key={item.label} style={styles.settingRow}>
                ...
                <Switch value={item.value} onValueChange={item.set} trackColor={{ true: item.color, false: '#ddd' }} />
              </View>
            ))}
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  typeBtn: {
    ...
    backgroundColor: 'rgba(180,180,200,0.2)', alignItems: 'center',
  },
  typeBtnActive: { backgroundColor: '#8b6fd4' },
  typeBtnText: { fontSize: 14, fontWeight: '600', color: '#888' },
  typeBtnTextActive: { color: '#fff' },
  input: {
    backgroundColor: 'rgba(240,235,250,0.8)', borderRadius: 12,
    paddingVertical: 12, paddingHorizontal: 14, fontSize: 14, color: '#333',
  },
  addBtn: { backgroundColor: '#8b6fd4', borderRadius: 12, paddingVertical: 12, alignItems: 'center' },
  ...
  saveText: {
    fontSize: 32, fontWeight: 'bold', color: '#5bbfb0',
    textDecorationLine: 'underline', textAlign: 'center', marginTop: 8,
  },
});