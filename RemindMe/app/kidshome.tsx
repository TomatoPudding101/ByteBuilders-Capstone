...
const MENU_ITEMS = [
  ...
  {
    label: 'My Progress',
    image: require('../assets/images/dash-icons/My-Progress.jpg'),
    color: '#3cc470',
    route: '/kidsprogress1',
  },
  {
    label: 'My Rewards',
    image: require('../assets/images/dash-icons/My-Rewards.jpg'),
    color: '#e8a020',
    route: '/kidsrewards1',
  },
  {
  ...
  {
    label: 'Settings',
    image: require('../assets/images/dash-icons/Settings.jpg'),
    color: '#6655cc',
    route: '/settings',
  },
];
